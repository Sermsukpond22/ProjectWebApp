...
(6, 'Booth A', '10x10', 'available', 1500.00, 'http://example.com/image1.jpg', 2),
(8, 'Booth A', '10x10', 'available', 1500.00, 'http://example.com/image1.jpg', 2),
(9, 'Booth A6', '10x10', 'booked', 1500.00, 'http://example.com/image1.jpg', 2),
(10, 'Booth A8', '10x10', 'under_review', 1500.00, 'http://example.com/image1.jpg', 2),
(11, 'Booth A9', '10x10', 'booked', 1500.00, 'http://example.com/image1.jpg', 2),
(12, 'Booth A10', '10x10', 'available', 1500.00, 'http://example.com/image1.jpg', 2);
...
(1, 'Updated Music Festival 2024', '2024-09-18', '2024-10-22');
...
CREATE TABLE `reservations` (
  ...
  `status` enum('cancel_reserve','approve','under_review','reserve') NOT NULL,
...
(1, 3, 6, '2024-09-15', 'cancel_reserve', 'pending', 'http://example.com/proof.jpg'),
(3, 1, 6, '2024-09-15', '', 'paid', 'http://example.com/proof.jpg'),
(5, 1, 6, '2024-09-16', '', 'pending', 'http://example.com/proof.jpg sddsd'),
(6, 1, 9, '2024-09-25', 'cancel_reserve', 'pending', 'http://example.com/proof.jpg'),
(7, 3, 8, '2024-09-26', 'cancel_reserve', 'pending', 'https://example.com/payment.jpg'),
(8, 3, 9, '2024-09-30', 'reserve', 'pending', 'https://example.com/payment.jpg'),
(9, 3, 10, '2024-09-14', 'under_review', 'pending', 'https://example.com/payment.jpg'),
(10, 3, 11, '2024-09-14', 'reserve', 'pending', 'https://example.com/payment.jpg');
...
(2, 'Pond', 'Boonsaen', '081145678', 'pond22@example.com', '$2y$10$Z8EgkKIJZuvZzVHpaHns7OfwVbwA53eKaoXPqvgxZA70xpxKLUvTG', 'member'),
